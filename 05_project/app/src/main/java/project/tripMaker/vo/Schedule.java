...
public class Schedule {
  ...
  // Getter and Setter for scheduleNo
  ...
  // Getter and Setter for locationNo
  ...
  // Getter and Setter for scheduleDay
  public Integer getScheduleDay() {
    return scheduleDay;
  }

  // Getter and Setter for scheduleRoute
