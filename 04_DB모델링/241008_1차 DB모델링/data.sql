...
('profile.jpg', NOW(), 'admin@example.com', 'password', '010-9999-0000', '관리자', 1, 0, 0),
('profile.jpg', NOW(), 'user1@example.com', 'password', '010-1234-5678', '여행자1', 1, 0, 1),
('profile.jpg', NOW(), 'user2@example.com', 'password', '010-2345-6789', '모험가2', 1, 0, 2),
('profile.jpg', NOW(), 'user3@example.com', 'password', '010-3456-7890', '배낭족3', 1, 0, 3),
('profile.jpg', NOW(), 'user4@example.com', 'password', '010-3456-7800', '배낭족4', 1, 0, 0),
('profile.jpg', NOW(), 'user5@example.com', 'password', '010-3456-7000', '배낭족5', 1, 0, 0);
...
(3, 6, '우리집민박', 'TV에도 나온집', 'minbak.jpg', '064-777-9999', '제주특별자치도 제주시 970로 170-61', 33.361666, 126.522166);
...
(1, '서울 문화 투어 후기', 4, 1, '서울의 문화를 체험한 5일간의 여행 후기입니다.', '#서울 #문화여행'),
...
(3, 4, '부산 맛집 투어 정말 재밌을 것 같아요. 제가 함께 갈 수 있을까요?');
...
(1, 3, '경고 제제 알림', '지속적인 광고성 게시글 작성으로 제제드립니다.', 0)
(2, 3, '여행 계획 문의', '제주도 여행 계획에 대해 궁금한 점이 있어요.', 0),
(3, 4, '동행 요청', '부산 맛집 투어에 함께 가고 싶습니다!', 0);