...
CREATE TABLE location (
	...
	locationclass_no INTEGER      NULL      -- 여행지구분번호
);
...
-- 시도
CREATE TABLE state (
	state_code VARCHAR(50) NOT NULL, -- 시도코드
	state_name VARCHAR(50) NOT NULL  -- 시도명
);
...
-- 시군구
CREATE TABLE city (
	city_code  VARCHAR(50)  NOT NULL, -- 시군구코드
	state_code VARCHAR(50)  NULL,     -- 시도코드
	city_name  VARCHAR(50)  NOT NULL, -- 시군구명
	city_photo VARCHAR(255) NULL      -- 썸네일사진
);
...
CREATE TABLE locationclass (
	locationclass_no   INTEGER     NOT NULL, -- 여행지구분번호
	locationclass_name VARCHAR(50) NULL      -- 여행지구분명
);
