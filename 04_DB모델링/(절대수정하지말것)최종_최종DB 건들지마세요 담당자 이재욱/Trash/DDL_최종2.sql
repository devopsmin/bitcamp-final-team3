...
-- version 11 : 모든 user_no 관련 BIGINT로 변경
...
-- 유저
CREATE TABLE user (
                      user_no            BIGINT      NOT NULL AUTO_INCREMENT, -- 유저번호
                      ...
                      user_role          VARCHAR(20)  NOT NULL DEFAULT 'ROLE_USER', -- 권한여부
...
CREATE TABLE letter (
                        ...
                        send_user_no     BIGINT       NULL,     -- 발신자번호
                        receive_user_no  BIGINT       NULL,     -- 수신자번호
